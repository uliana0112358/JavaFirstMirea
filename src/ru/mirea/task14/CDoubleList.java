...
public class CDoubleList {
    static int n = 10;
    public static LinkedList<Card> first = new LinkedList<>();
    public static LinkedList<Card> second = new LinkedList<>();
    ...
    public static void main(String[] args) {
        ...
        while (true){
            count++;
            Card card1 = first.pollFirst(); //то же, что и pop()
            Card card2 = second.pollFirst();
